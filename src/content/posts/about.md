...
draft: false
canonicalURL: 'https://devdiary.uk/about'
---

<!-- REVISED DRAFT — addressing Jester Full Roast verdict (tsk-2026-06-13-002). Complexity 5. -->
<!-- SCHEMA: Person -->
<!-- SCHEMA: FAQPage -->
...
- Build logs and architecture write-ups for the agent systems and tools I'm working on — including the full deep-dive on [setting up a Personal Claude OS](/blog/claude-code-personal-os-guide).
