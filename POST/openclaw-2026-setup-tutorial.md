...
| `"Another gateway instance is listening"` | Port collision with stale `moltbot`/`clawdbot` daemon | `openclaw gateway stop --all`, then clear stale systemd/launchd services |
